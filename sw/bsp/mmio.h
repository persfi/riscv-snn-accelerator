...
#define MMIO_SW (*(volatile unsigned int *)(SW_ADDR))
...
#define ACCEL_H_SHIFT_ADDR  (ACCEL_BASE + 0x30u)
...
#define ACCEL_H_SHIFT       (*(volatile unsigned int *)(ACCEL_H_SHIFT_ADDR))
